// Thanks Too : Ramlan ID, Aqulz, Mhankbarbar, Rahman Whatsapp, Adiwajshing/Bailleys, And Your
// Jangan Di Ubah² Di Atas Itu! 
// Kalau Diubah² Ga saya Up lagi!
"use strict";
const {
    WAConnection,
    MessageType,
...
module.exports = async(aulia, msg, blocked, baterai, _afk, welcome, left) => {
    try {
        const { menu, newMenu, stickerMenu, ownerMenu, groupMenu, sistemMenu, gabutMenu, gameMenu, downloadMenu, searchMenu, stalkMenu, randomMenu, animeMenu, toolsMenu, makerMenu, otherMenu, hentaiMenu, storageMenu, rahmanMenu, beliPremium, sewabotMenu} = require("./help");
       ...
       if (isGroup && isAntilinkIg && !isOwner && !isGroupAdmins && isBotGroupAdmins){
        ...
        switch(command){
            ...
            case prefix+'sewabot': case prefix+'sewabotrahman':{
                textImg(sewabotMenu(setting.botName, setting.nomorPenjual))
            }
                 break
//------------------< Sticker / Tools >-------------------
            case prefix+'exif':{
...
//------------------< INFO >-------------------
            ...
            case prefix+'sourcecode': case prefix+'sc': case prefix+'src':
                textImg(`Bot ini menggunakan sc : https://github.com/aulia-Team/auliaBot`)
                break
            case prefix+'runtime':
                textImg(`「 RUNTIME HASKIMURA 」\n\n${runtime(process.uptime())}`)
                break
            case prefix+'stats': 
            case prefix+'botstat':{
